...
//     // { name: 'Add Report', to: '/add' },
//     // { name: 'View Report', href: '/view' },
//   ]
    ...
    <>
      <div className="back">
        ...
        <svg
            ...
            viewBox="0 0 1155 700" style={{zIndex:"5",filter:"blur(55px)"}}
          >
            <path
              fill="url(#45de2b6b-92d5-4d68-a6a0-9b9b2abad533)"
              fillOpacity=".4"
          ...
          <h2 className="landMain">Boost Your Productivity</h2>
          <p className='landP'>
          Check out our management tips, tools, templates, and productivity hacks to start saving one day a week.
          </p>
          <Link to="/getStarted" className='landB'>
            Get started
          </Link>
      </div>
      </div> 
